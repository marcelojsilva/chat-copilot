...
/*
Summary: Tests if the Chat AI can use the Planner with the Klarna plugin, 
...
export async function klarnaTest(page) {
    ...
    await expect(chatHistoryItems.last()).toHaveAttribute('data-username', 'Bot');
...
/*
Summary: Tests if the Chat AI can use the Planner with the Jira plugin, 
...
/*
Summary: Tests if the Chat AI can use the Planner with the Github plugin, 
